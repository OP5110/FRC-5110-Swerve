...
public class Robot extends TimedRobot
{
  ...
  // The first parameter is the device ID on the CAN bus, and the second is the motor type


  // Initialize the built-in encoder associated with the Spark MAX
    ...
    */
    //m_encoder = convMotor.getEncoder();
  ...
  public void autonomousInit()
  {
    ...
    //sparkMaxEncoder.setPosition(0.0);
  ...
  {
    // Get the current position (rotations) and velocity (RPM) of the encoder
    //double position = sparkMaxEncoder.getPosition();
    //double velocity = sparkMaxEncoder.getVelocity();
  
  // Print the values to the console or SmartDashboard
